...
<body>
	<div id="side-bar" class="col-sm-2" style="font-size: 10pt;">
	    <div class="list-group">
	        ...
	        <a class="list-group-item list-group-item-action" href="<%=request.getContextPath()%>/missionList.jsp">미션 등록 현황</a>
	        <a class="list-group-item"><b>포인트상품 관리</b></a>
	        <a class="list-group-item list-group-item-action" href="<%=request.getContextPath()%>/goods/goods_all.jsp">포인트 상품</a>
